...
% iteration
function [f_EnIOut,meanVs,loop,SteadyIndicate,FailureIndicate] = MeanFieldEst_Drive_SNW(C_EE,C_EI,C_IE,C_II,... %4
                                   ...
                                   %This line: Just relic from earlier verion, I would rather don't change it now (for the sake of nargin) 
